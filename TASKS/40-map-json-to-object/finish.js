...
const postsJS = postsJSON.map((el) => {
  return JSON.parse(el); // преобразуем каждый элемент из массива, который содержит
})
...
console.log(postsJS[postsJS.length - 1].commentsQuantity) // Второй вариант вывода последнего объекта в массиве.